...
void squeezenet_init_int8(ncnn::Net& net)
{
    net.load_param("squeezenet-int8.param");
}
...
void mobilenet_init_int8(ncnn::Net& net)
{
    net.load_param("mobilenet-int8.param");
}
...
void mobilenet_ssd_init_int8(ncnn::Net& net)
{
    net.load_param("mobilenet_ssd-int8.param");
}
...
int main(int argc, char** argv)
{
    ...
    // benchmark("squeezenet-int8", squeezenet_init_int8, squeezenet_run);

    // benchmark("mobilenet", mobilenet_init, mobilenet_run);

    // benchmark("mobilenet-int8", mobilenet_init_int8, mobilenet_run);
    ...
    benchmark("mobilenet-ssd-int8", mobilenet_ssd_init_int8, mobilenet_ssd_run);
